...
namespace RGN { namespace Modules { namespace UserProfile {
    struct UserProfilePicture : public RGN::Model::ImageUrl {
        ...
        friend void to_json(nlohmann::json& nlohmann_json_j, const UserProfilePicture& nlohmann_json_t) {
        ...
        friend void from_json(const nlohmann::json& nlohmann_json_j, UserProfilePicture& nlohmann_json_t) {
