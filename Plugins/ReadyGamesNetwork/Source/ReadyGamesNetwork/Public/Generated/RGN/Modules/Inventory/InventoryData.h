...
namespace RGN { namespace Modules { namespace Inventory {
    struct InventoryData {
        ...
        friend void to_json(nlohmann::json& nlohmann_json_j, const InventoryData& nlohmann_json_t) {
            nlohmann_json_j["id"] = nlohmann_json_t.id;
            nlohmann_json_j["quantity"] = nlohmann_json_t.quantity;
        }

        friend void from_json(const nlohmann::json& nlohmann_json_j, InventoryData& nlohmann_json_t) {
