...
namespace RGN { namespace Modules { namespace Leaderboard {
    ...
    public:
        static void GetLeaderboardByIdAsync(
            string& id,
            const function<void(RGN::Modules::Leaderboard::LeaderboardData& result)>& compelete,
        ...
        static void GetLeaderboardByRequestNamesAsync(
            ...
            const function<void(vector<RGN::Modules::Leaderboard::LeaderboardData>& result)>& compelete,
            const function<void(int httpCode, string error)>& fail) { }
        ...
        static void SetScoreAsync(
            ...
            int32_t score,
            string& extraData,
            const function<void(int32_t result)>& compelete,
            const function<void(int httpCode, string error)>& fail) { }
        ...
        static void GetUserEntryAsync(
            string& leaderboardId,
            const function<void(RGN::Modules::Leaderboard::LeaderboardEntry& result)>& compelete,
            const function<void(int httpCode, string error)>& fail) { }
        static void GetEntriesAsync(
            ...
            const function<void(vector<RGN::Modules::Leaderboard::LeaderboardEntry>& result)>& compelete,
            const function<void(int httpCode, string error)>& fail) { }
    };
}}}