...
namespace RGN { namespace Modules { namespace Store {
    struct BuyVirtualItemsResponse {
        ...
        friend void to_json(nlohmann::json& nlohmann_json_j, const BuyVirtualItemsResponse& nlohmann_json_t) {
        ...
        friend void from_json(const nlohmann::json& nlohmann_json_j, BuyVirtualItemsResponse& nlohmann_json_t) {
