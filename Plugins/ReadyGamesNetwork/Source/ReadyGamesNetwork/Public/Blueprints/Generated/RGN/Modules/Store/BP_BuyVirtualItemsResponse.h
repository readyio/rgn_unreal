...
#include "BP_BuyVirtualItemsResponse.generated.h"

USTRUCT(BlueprintType)
struct READYGAMESNETWORK_API FBP_BuyVirtualItemsResponse {
    GENERATED_BODY()
	...
	static void ConvertToCoreModel(const FBP_BuyVirtualItemsResponse& source, RGN::Modules::Store::BuyVirtualItemsResponse& target) {
