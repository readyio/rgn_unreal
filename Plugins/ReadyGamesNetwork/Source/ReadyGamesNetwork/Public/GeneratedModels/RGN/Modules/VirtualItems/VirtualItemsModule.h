...
namespace RGN { namespace Modules { namespace VirtualItems {
    ...
    public:
        static void AddVirtualItemAsync(
            ...
            const function<void(RGN::Modules::VirtualItems::VirtualItem& result)>& compelete,
        ...
        static void GetVirtualItemsAsync(
            const function<void(vector<RGN::Modules::VirtualItems::VirtualItem>& result)>& compelete,
            const function<void(int httpCode, string error)>& fail) { }
        static void GetVirtualItemsAsync(
            int32_t limit,
            string& startAfter,
        ...
        static void DownloadMaterialTexturesAsync(
            string& virtualItemId,
            System::Threading::CancellationToken& cancellationToken,
            const function<void(vector<vector<byte>>& result)>& compelete,
            const function<void(int httpCode, string error)>& fail) { }
    };
}}}